...
class Cell:
    ...
    def __init__(self, quantity: int):
        if isinstance(quantity, (int)) is False or quantity < 0:
            raise ValueError('Только целое не отрицательное число!')
        self.q = quantity
    ...
    def __sub__(self, other):
        return Cell(self.q - other.q) if self.q - other.q >= 0 \
            else print('Разница не должна быть отрицательной!')
...
def methods_and_types(a, b, c, d, e, f):
    print('Meaning of a:', a)
    print('Meaning of b:', b)
    print('Type of c:', type(c))
    print('Rezult of c = a + b:', c)
    print('Type of d:', type(d))
    print('Rezult of d = a - b:', d)
    print('Type of e:', type(e))
    print('Rezult of e = a * b:', e)
    print('Type of f:', type(f))
    print('Rezult of f = a / b:', f)
    print('-----------------------------------------')
